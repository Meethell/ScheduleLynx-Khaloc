...
{
    public class InstrumentModelViewModel : Screen
    {
        private readonly InstrumentViewModel _instrumentViewModel;
        // Constructor
        public InstrumentModelViewModel(InstrumentViewModel instrumentViewModel)
        {
        ...
        public void LoadData()
        {
            ...
            Countries = new ObservableCollection<Country>(CachesServices.Instance.Countries);
            ModelTypes = new ObservableCollection<ModelType>(CachesServices.Instance.ModelTypes.FindAll(x => x.IsConsumable == false));
        }
        ...
        public void LoadModel()
        {
            ...
            {
                ModelTypes = new ObservableCollection<ModelType>(CachesServices.Instance.ModelTypes.FindAll(x => x.IsConsumable == false));
                Models = new ObservableCollection<Model>(CachesServices.Instance.Models.FindAll(x => x.ManufacturerId == SelectedManufacturer.Id && x.IsConsumable == false));
            }
        }
        ...
        public void bnModelNew()
        {
            ...
            Models.Add(new Model
            {
                ...
                //InstrumentTypeId = 1,
                //InstrumentType = InstrumentTypes.FirstOrDefault(c => c.Id == 1)
            });
            NotifyOfPropertyChange(() => Models);
        ...
        public string SearchManufacturer
        {
            ...
            set
            {
                ...
                {
                    Manufacturers = new ObservableCollection<Manufacturer>(CachesServices.Instance.Manufacturers.Where(c => c.Name.ToLower().Contains(SearchManufacturer.ToLower())));
                }
            }
        }
        // Tìm kiếm Model
        ...
        public string SearchModel
        {
            ...
            set
            {
                ...
                {
                    LoadModel();
                    _tempModel = new List<Model>(Models);
                    Models = new ObservableCollection<Model>(_tempModel.Where(c => c.Name.ToLower().Contains(SearchModel.ToLower())));
                }
            }
        }

        // Xem chi tiết InstrumentModel
        public async Task OpenModelDetailViewCommand()
        {
            _instrumentViewModel.IsInstrumentModelDetailViewChecked = true;
           await _instrumentViewModel.InstrumentModelDetailView(SelectedModel);
        }
    }
}
